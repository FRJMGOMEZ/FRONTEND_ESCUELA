...
export class DemoService {
  ...
  loginPopup(onclick:boolean = false){
   ...
   {Swal.fire({
        ...
        text: 'Los usuarios habilitados como administradores son: FREDDIE con password 123 y JOHN con password 123. Puedes utilizar CHROME para loggearte con uno y MOZILLA para loggearte con otro con el fin de probar la interacción en tiempo real entre los dos'
        , type: "warning",
