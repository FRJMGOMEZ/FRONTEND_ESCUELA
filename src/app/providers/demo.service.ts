...
export class DemoService {
  ...
  loginPopup(onclick:boolean = false){
   ...
   {Swal.fire({
     ...
     text: 'Los usuarios habilitados como administradores son: freddieQueen@gmail.com , janisJap@gmail.com ,lennonJohn1940@gmail.com ,y ninaSim@gmail.com, el password de los tres es 123. Puedes utilizar CHROME para loggearte con uno y MOZILLA para loggearte con otro con el fin de probar la interacción en tiempo real entre los dos'
        , type: "warning",
